---
title           : "Predictors of emotion regulation in adolescence: A Systematic Review"
shorttitle      : "EMOTION REGULATION ADOLESCENCE"
...
This systematic review aims to identify all predictors considered relevant in relation to adolescent emotion regulation. 
...
This is an inductive study. There are no hypotheses.
...
**Other**. This is a systematic review of published studies. However, the purpose of the systematic review is not to meta-analyze effect sizes, but to identify and categorize predictors of adolescent emotion regulation.
...
This preregistration is composed before the systematic search is conducted.
...
The present study concerns a systematic review of the published literature on adolescent emotion regulation. No effort has been made, as of this writing, to search that literature.
...
To collect the data, we will follow the procedures described by Janneke Staaks on https://osf.io/49t8x/, DOI:10.17605/OSF.IO/49T8X, accessed on 27-01-2020. Specifically, we will follow the guidelines in these documents:

1. Systematic searching
* Building a search strategy.pdf
* Database Syntax .pdf
* Subject Headings and Other Search Fields.pdf
3. Exporting from databases
* Exporting References.pdf
* Word Distance.pdf
...
TS=(("emotio* regulation" OR "anger regulation" OR "sadness regulation" OR "emotion* competence" OR "emotion* adjustment" OR "internalizing" OR "emotio* dysregulation" OR "anger dysregulation" OR "sadness dysregulation" OR "emotio* problem*" OR "emotion* maladjustment") AND (adolescent* OR teen* OR puber* OR youth))

### Databases

We will apply these procedures to the following databases, provided we can access them and can export citations + abstracts from them (the abstracts are required for screening in ASReview):
...
For each included paper, we will code the following:

* sc_authors: The authors
* sc_pub_year: Year of publication
* sc_title: Study title
* sc_journal: Outlet of publication
* sc_doi: DOI
* sc_pub_type: Type of publication
* sc_country: Country of lead author
* sc_eligible: Eligibility
* sc_exclude_reason: Optional reason for exclusion
* sa_dataset_name: If applicable, which larger dataset the sample is obtained from
* sa_data_year: Optional, year of data collection
* sa_N: Sample size
* sa_age_m: Mean age of adolescents
* sa_p_male: Proportion of male adolescents
* sa_country: Sample country of origin
* de_manipulation: Dichotomous; was an (experimental) manipulation or intervention applied?
* de_longitudinal: Dichotomous; is this a longitudinal study?
* dv_des: Describe the DV (emotion regulation)
* dv_instrumentname: What instrument was used to measure emotion regulation?
* dv_type: Categorize this DV (e.g., emotion regulation, emotional adjustment, internalizing problems)
* relevance: How relevant the article is on a scale of 1-4
* theories: References of theoretical papers used to substantiate the analyses, if any. DOIs, separated by ;.
* cormat: Filename of a .csv file; If emotion regulation is included in a correlation matrix, we will digitize the correlation matrix as a .csv file.
* predictors: Variables that were used to predict emotion regulation, separated by commas
* covars: Control variables that were used to predict emotion regulation, separated by commas
...
* They do not examine emotion regulation as a dependent variable
* They do not include any predictors of emotion regulation
* They do not study adolescents (age 10-19)
* They do not conduct quantitative analysis
