...
abstract: |
  <!--RK: Wat is je onderzoeksvraag?-->Adolesence is a developmentally sensititve period for emotion dysregulation.
...
as one in five, adolescence marks the onset of emotion
...
As a result, there is a lack of unifying theory, and narrative reviews fall short of comprehensive coverage of the vast but diffuse literature [@bussTheoriesEmotionalDevelopment2019].

The present systematic review seeks to overcome this limitation by adopting a novel method -
...
The results of our text mining analysis of the empirical literature on adolescents' emotion regulation will be best understood against the backdrop of the existing theoretical landscape.
We distinguish the topics covered in this theoretical review visually to highlight new issues
in the subsequent text mining analysis.
...
We provide only a summary theoretical review here, as other recent publications offer more detailed reviews of theories of emotional development [@bussTheoriesEmotionalDevelopment2019] and emotion regulation in adolescence [@riedigerEmotionRegulationAdolescence2014].
These prior reviews remark that,
although many theories are *relevant* for emotion regulation development in adolescence,
few have addressed this topic directly.
...
These theories explain socialization in great detail,
but one potential limitation is that tey are not embedded in a larger unifying framework.
...
but limited by a lack of specificity, which hampers their utility in generating hypotheses.
...
<!--Consider splitting this up and putting the shortcomings next to the existing theories-->
...
One crucial shortcoming is that most theories lack of explicit attention to the life stage of adolescence.
It is questionable whether theories focused on different ages can be generalized to adolescents,
because this stage differs qualitatively from infancy, childhood, and adulthood [@bariolaChildAdolescentEmotion2011].
A related limitation is that many relevant theories lack
an explicit developmental component <!--, and thus lack a well-substantiated
understanding of developmental processes--> [see
@bussTheoriesEmotionalDevelopment2019;
@croneUnderstandingAdolescencePeriod2012]. 
Perhaps most importantly, however, these theories
vary widely in scope: Some are broad but somewhat non-specific, such as the biopsychosocial models of Bronfenbrenner and Sameroff, and others describe a specific phenomenon, but lack a broader perspective.
It would be beneficial to bridge these levels of analysis.
Based on these shortcomings,
there appears to be a need for more theory generation,
...
review of the field.
Concepts covered in the preceding theoretical review will be tagged in the text mining analysis,
to highlight the contribution of the inductive approach.
...
childhood.
They further argued that the role of fathers in emotion socialization warrants further scrutiny - a topic that is now receiving more attention [@vanlissaRoleFathersMothers2019;
...
These include individual differences, both at the biological and psychological level, including genetic predisposition, hormones, pubertal onset, gender, sexuality, temperament, identity, empathy, and stress.
Proximal influences not covered in theory include the role of media, norms, and social status.
Thus, reviews of the empirical literature can contribute additional insight into key factors in adolescents' emotion regulation development.
One remaining limitation is that all reviews in this field have been unstructured narrative reviews.
The present publication seeks
...
of emotion regulation, added 191 new hits. However, most of these did not meet the inclusion criteria used for screening, as explained below.
The term `"development*"`, as synonym
...
This illustrates how inductive reviews may complement existing theory and narrative reviews, and can reveal blindspots.<!-- SH: this point/advantage needs to feature more prominently in the introduction!-->

Connections among topics were relatively sparse: Many constructs were only related to emotion regulation,
...
This resulted in a dataset consisting of `r lda_dims_2[1]` documents and `r lda_dims_2[2]` terms.
We considered a range from 2-20 topics, evaluating fit based on the BIC, and interpretability based on the entropy of the posterior document/topic probabilities.
...
but nonetheless occur frequently in the empirical literature.<!--RK: But is that a bad thing? Can you please elaborate?-->
...
One such limitation is the fact that the text mining techniques used here
