...
```{r study1varimp, warning=FALSE, eval = TRUE, results='asis', out.width = "100%", fig.cap="Document frequency of terms selected for Study 1. Dashed lines and transparent circles indicate constructs also represented in the theory (cf Figure 1)."}
...
```{r study2varimp, eval = TRUE, out.width = "100%", results='asis', fig.cap="Document frequency of terms selected for Study 2. Dashed lines and transparent circles indicate constructs also represented in the theory (cf Figure 1)."}
...
and performed a text-mining based systematic review to map constructs related to adolescent emotion regulation.
