...
life course persistent psychopathology [@leeAdolescentMentalHealth2014]
rooted in emotion regulation difficulties
...
prior reviews have argued that it is difficult to obtain a comprehensive understanding of emotion regulation in adolescence [@riedigerEmotionRegulationAdolescence2014] because
because different (sub)disciplines have approached the issue in disparate ways [@riedigerEmotionRegulationAdolescence2014],
in the absence of consistent terminology [@bariolaChildAdolescentEmotion2011] and conceptual frameworks [@stifterEmotionRegulation2019], and a lack of unifying theory 
[@bussTheoriesEmotionalDevelopment2019].

The fragmented state of the literature has prompted recent calls for the integration of heterogeneous research areas [@riedigerEmotionRegulationAdolescence2014] and consolidation of empirical insights into overarching theory [e.g., @bussTheoriesEmotionalDevelopment2019].
Formal methods for theory construction state that the first step in this endeavor is to identify the relevant *empirical phenomena* [@borsboomTheoryConstructionMethodology2020],
defined as stable and general features of the world[@@bogenSavingPhenomena1988].
The present paper argues that systematic reviews are a suitable method for taking this first step,
