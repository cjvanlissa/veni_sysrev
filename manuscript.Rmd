...
as one in five individuals, adolescence marks the onset of
emotion regulation difficulties and associated mental health problems,
which can persist throughout the life course
...
Adolescence is a life stage defined by biological and socio-cultural factors,
ranging from pubertal onset to adult-like independence [approximately 10-24 years of age, @steinbergAgeOpportunityLessons2014; @sawyerAgeAdolescence2018].
It constitutes a developmentally sensitive period for
mature emotion regulation skills, during which children experience
...
Consequently, adolescents experience more frequent and intense (negative) emotions than children or adults [see @silkAdolescentsEmotionRegulation2003].
...
Eventually, most adolescents emerge ready to take on the challenges of
early adulthood. Unfortunately, a sizable proportion of adolescents instead
...
-->
According to meta-analyses, such difficulties in emotion regulation are associated with
extensive and persist internalizing, and to a lesser extent, externalizing, psychopathology
...
related to adolescent emotion regulation, based on a systematic review of
...
we manually classified each of the selected terms as either a putative 'Cause', 'Outcome', 'Protective factor', or 'Indicator' of emotion regulation.
We stress that this classification is subjective and acknowledge that many of these associations are likely to be bidirectional [e.g., emotion regulation is known to both predict and be predicted by conflict with parents, @vanlissaCostEmpathyParentadolescent2017].
...
Based on the co-occurrence graph (Figure \@ref(fig:allnetworks)),
...
This first analysis used author keywords to map common topics in the literature pertaining to adolescents' emotion regulation.
...
Figure \@ref(fig:allnetworks) displays the resulting matrix as a force directed graph.
