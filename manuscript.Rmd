...
which would additionally involve abductive reasoning: specifying putative mechanisms to explain associations between the phenomena [@borsboomTheoryConstructionMethodologya].
...
<!-- Co-occurrence -->
With regard to the term co-occurrence analyses, the analysis of  keywords (Analysis 1, see Figure \@ref(fig:allnetworks)) indicated that 
