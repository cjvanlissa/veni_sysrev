...
abstract: |
  For many, adolescence marks the onset of emotion dysregulation and related mental health problems. It is therefore essential to have a solid grasp of relevant risk factors. Despite an abundance of empirical research, the literature is somewhat fragmented, as the topic has been investigated from different perspectives across subdisciplines. This systematic review uses text mining to map factors related to adolescent emotion dysregulation. A systematic search for publications that addressed emotion regulation in participants between the ages of 10-25 yielded 6305 suitable papers. One analysis focused on author-provided keywords, and a second extracted sequences of adjectives and nouns from the abstracts. Terms were classified with a dictionary describing 105 terms using 434 regular expressions. Terms were coded as putative “Causes”, “Outcomes”, “Protective factors”, or “Indicators” of emotion dysregulation. We reported term/document frequency, and force-directed graphs of term co-occurrence. These results reﬂected constructs commonly featured in theory and narrative reviews, but also identified underrepresented terms. This illustrates how text mining review may complement narrative reviews. Importantly, most constructs were directly related to emotion dysregulation, with few interconnections between constructs – reflecting the fragmented literature. This research constitutes a first step towards integrating the literature, and may inspire future empirical and theoretical work.
...
This systematic review seeks to overcome this limitation by using
bibliographic analysis to map all factors currently
considered to be relevant to adolescent emotion regulation. <!-- Ergens anders: Similarly, although
...
@riedigerEmotionRegulationAdolescence2014]. Thanks, in part, to these efforts,
...
Several other models echo this emphasis on neorocognitive development as a driver of emotional
development, including emotion regulation development.
...
@caseyBrakingAcceleratingAdolescent2011]. To
a greater extent than related writings, however, @croneUnderstandingAdolescencePeriod2012
set out to explain adolescents' diverging destinies; the
...
Whereas our primary interest is in theories of emotional development,
theories of the phenomenon of
...
Second, the target population must overlap with the life phase of adolescence, defined as the age range from 10-25.
